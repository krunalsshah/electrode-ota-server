...
module.exports.register = diregister({
   ...
   return Promise.all(map(options.strategy, (obj, key) => obj && new Promise((resolve, reject)=> {
        ...
        const plugin = typeof obj.module != 'string' ? obj.module : require(obj.module.startsWith('electrode-ota-server-') ? `/Users/blemair/Code/electrode-ota-server${obj.module}` : obj.module);
